				...
				<div class="row costumrow">
					...
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 clearfix productinside">
						<div class="col-md-12 propath">
						 	<h3><a href="products.php">PRODUCTOS</a>  >>  Fundición de aluminio</h3>	
				 		</div>
						<h1>Fundición de aluminio</h1>
						<p id="fade">Todo lo mejor de AL casting según la petición del cliente.</p>
				...
				<div class="row costumrow">
					...
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1" id="stick1">
						<div class="featurecontant">
    						<div class="sticky">
  								<h3>12" VIERNES HARBOR MOORING CLEAT MILL FINISH A356.0-T6</h3>
  							</div>
						</div>
					</div>
			...
			<div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					...
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1">
						<div class="featurecontant">
							<div>
								<h3>8" VIERNES HARBOR MOORING CLEAT MILL FINISH A356.0-T6</h3>
							</div>
 						</div>
					</div>
				</div>
