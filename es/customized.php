	...
	<div class="feturedimage">
		<div class="row firstrow">
			...
			<div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-5 col-md-7 col-lg-7 slideimg" id="topimg">
						<img src="../image/1920_900/005.jpg" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 clearfix productinside">
						<div class="col-md-12 propath">
						 	<h3><a href="products.php">PRODUCTS</a>  >>  Customized</h3>	
				 		</div>
						<h1>Aluminum Customized Extrusion</h1>
						<p id="fade">Sinobec LLC provide a complete package of service which lead to the production of customized dies.  We are capable to handle the whole process from the drawing, die design and cutting, sample calibrate to the final.</p>
			...
			<div class="col-lg-12 costumcol colborder2" id="cntd">
				<div class="row costumrow">
					...
					<div class="col-xs-12 col-sm-5 col-md-7 col-lg-7 slideimg">
						<img src="../image/1920_900/011.jpg" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1" id="stick1">
						<div class="featurecontant">
    						<div class="sticky">
  								<h3>FINISHING</h3>
								<p><span>MILL FINISH</span></p>
								<p><span>POWDER COATING</span></p>
								<p><span>LIQUID COATING</span></p>
								<p><span>ANODIZE</span></p>
								<p><span>BRUSH NICKLE</span></p>
  							</div>
						</div>
					</div>
			...
			<div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-5 col-md-7 col-lg-7 slideimg">
						<img src="../image/1920_900/006.jpg" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1">
						<div class="featurecontant">
							<div class="profile">
								<h3>Fabrication</h3>
								<p><span>Precision cutting</span></p>
								<p><span>Punching, stamping</span></p>
			 				</div>
 						</div>
					</div>
				</div>
			...
			<div class="col-lg-12 costumcol colborder2">
			 ...
			 <div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-5 col-md-7 col-lg-7 slideimg">
						<img src="../image/1920_900/009.png" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1">
						<div class="featurecontant">
							<div class="profile">
								<h3>SOLAR FRAME Profiles</h3>
	 						</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-5 col-md-7 col-lg-7 slideimg">
						<img src="../image/1920_900/010.png" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 stick1">
						<div class="featurecontant">
							<div class="profile">
								<h3>WINDOW & DOOR Profiles</h3>
