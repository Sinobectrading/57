			...
			<div class="col-lg-12 costumcol colborder2">
				<div class="row costumrow">
					...
					<div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 clearfix productinside">
						...
						<h3 class="subtitle">Aluminum TUBE extrusion</h3>
						<ul>
							<li><a href="#RectangularTubeSharpCorner">RectangularTubeSharpCorner</a></li>
							<li><a href="#RectangularTubeRoundCorner">RectangularTubeRoundCorner</a></li>
							<li><a href="RoundTubing">RoundTubing</a></li>
						</ul>
						<p id="fade">Available Alloy 
